(function() {
  ...
  describe('Timeline model', function() {
    ...
    return describe('fetch', function() {
      return it('should reset reviews when success', function() {
            ...
            reviews: [
              {
                ...
                user: {
                  id: 2,
                  name: 'jack',
                  avatar: 'https://www.socialmenu.fm/jack.png'
                },
                dish: {
                  id: 3,
                  name: 'roast duck'
        ...
        return expect(timeline.trigger).toHaveBeenCalledWith('timeline:refetched');
      });
    });
  });
